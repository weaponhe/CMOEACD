...
public class MOP5 extends AbstractDoubleProblem {
    ...
    public MOP5(Integer numberOfVariables, Integer numberOfObjectives) throws JMetalException {
    ...
    public void evaluate(DoubleSolution solution) {
        ...
        f[0] = (1.0 + g) * solution.getVariableValue(0);
        f[1] = (1.0 + g) * (1 - Math.sqrt(solution.getVariableValue(0)));
    ...
    private double evalG(DoubleSolution solution, double[] t) throws JMetalException {
        ...
        g = 2.0 * Math.abs(Math.cos(Math.PI * solution.getVariableValue(0)) )* g;
