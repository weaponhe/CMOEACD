 ...
 */
//optimum  0.7499
public class g11 extends AbstractDoubleProblem implements ConstrainedProblem<DoubleSolution> {
    ...
    public void evaluate(DoubleSolution solution)  {
        ...
        double f = Math.pow(x[0],2.0) + Math.pow(x[1] - 1.0,2.0);
    ...
    public void evaluateConstraints(DoubleSolution solution) {
        ...
        constraint[0] = -(Math.abs(x[1] - Math.pow(x[0],2.0)) - Constant.EPSILON);//h
