...
public class MOP3 extends AbstractDoubleProblem {
    ...
    public MOP3(Integer numberOfVariables, Integer numberOfObjectives) throws JMetalException {
    ...
    public void evaluate(DoubleSolution solution) {
        ...
        f[0] = (1.0 + g) * Math.cos(Math.PI * solution.getVariableValue(0)/2.0);
        f[1] = (1.0 + g) * Math.sin(Math.PI * solution.getVariableValue(0) /2.0);
    ...
    private double evalG(DoubleSolution solution, double[] t) throws JMetalException {
        ...
        g = 2.0 * Math.sin(Math.PI * solution.getVariableValue(0) / 2.0) * g;
