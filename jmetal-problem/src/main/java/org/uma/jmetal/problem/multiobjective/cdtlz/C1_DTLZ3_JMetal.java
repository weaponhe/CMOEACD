...
public class C1_DTLZ3_JMetal extends DTLZ3 implements ConstrainedProblem<DoubleSolution> {
     ...
     */
    public C1_DTLZ3_JMetal(int numberOfVariables, int numberOfObjectives) {
