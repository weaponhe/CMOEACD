...
//    }
    switch (func_num){
      case 1:
        returnFunc = new F01ShiftedSphere(dimension,m_biases[func_num]);
        break;
      case 2:
        returnFunc = new F02ShiftedSchwefel(dimension,m_biases[func_num]);
        break;
      case 3:
        returnFunc = new F03ShiftedRotatedHighCondElliptic(dimension,m_biases[func_num]);
      break;
      case 4:
        returnFunc = new F04ShiftedSchwefelNoise(dimension,m_biases[func_num]);
      break;
      case 5:
        returnFunc = new F05SchwefelGlobalOptBound(dimension,m_biases[func_num]);
      break;
      case 6:
        returnFunc = new F06ShiftedRosenbrock(dimension,m_biases[func_num]);
      break;
      case 7:
        returnFunc = new F07ShiftedRotatedGriewank(dimension,m_biases[func_num]);
      break;
      case 8:
        returnFunc = new F08ShiftedRotatedAckleyGlobalOptBound(dimension,m_biases[func_num]);
      break;
      case 9:
        returnFunc = new F09ShiftedRastrigin(dimension,m_biases[func_num]);
      break;
      case 10:
        returnFunc = new F10ShiftedRotatedRastrigin(dimension,m_biases[func_num]);
      break;
      case 11:
        returnFunc = new F11ShiftedRotatedWeierstrass(dimension,m_biases[func_num]);
      break;
      case 12:
        returnFunc = new F12Schwefel(dimension,m_biases[func_num]);
      break;
      case 13:
        returnFunc = new F13ShiftedExpandedGriewankRosenbrock(dimension,m_biases[func_num]);
      break;
      case 14:
        returnFunc = new F14ShiftedRotatedExpandedScaffer(dimension,m_biases[func_num]);
      break;
      case 15:
        returnFunc = new F15HybridComposition1(dimension,m_biases[func_num]);
      break;
      case 16:
        returnFunc = new F16RotatedHybridComposition1(dimension,m_biases[func_num]);
      break;
      case 17:
        returnFunc = new F17RotatedHybridComposition1Noise(dimension,m_biases[func_num]);
      break;
      case 18:
        returnFunc = new F18RotatedHybridComposition2(dimension,m_biases[func_num]);
      break;
      case 19:
        returnFunc = new F19RotatedHybridComposition2NarrowBasinGlobalOpt(dimension,m_biases[func_num]);
      break;
      case 20:
        returnFunc = new F20RotatedHybridComposition2GlobalOptBound(dimension,m_biases[func_num]);
      break;
      case 21:
        returnFunc = new F21RotatedHybridComposition3(dimension,m_biases[func_num]);
      break;
      case 22:
        returnFunc = new F22RotatedHybridComposition3HighCondNumMatrix(dimension,m_biases[func_num]);
      break;
      case 23:
        returnFunc = new F23NoncontinuousRotatedHybridComposition3(dimension,m_biases[func_num]);
      break;
      case 24:
        returnFunc = new F24RotatedHybridComposition4(dimension,m_biases[func_num]);
      break;
      case 25:
        returnFunc = new F25RotatedHybridComposition4Bound(dimension,m_biases[func_num]);
      break;
    }
    return (returnFunc);
  }
