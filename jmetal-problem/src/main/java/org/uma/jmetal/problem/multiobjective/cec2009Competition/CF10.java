 ...
 */
public class CF10 extends AbstractDoubleProblem implements ConstrainedProblem<DoubleSolution> {
    ...
    public void evaluateConstraints(DoubleSolution solution) {
        ...
        double N = 2.0;
        double a = 1.0;
        constraint[0] = (Math.pow(solution.getObjective(0),2.0)+Math.pow(solution.getObjective(1),2.0))/(1-Math.pow(solution.getObjective(2),2.0)) - a*Math.sin(N*Math.PI*((Math.pow(solution.getObjective(0),2.0)-Math.pow(solution.getObjective(1),2.0))/(1-Math.pow(solution.getObjective(2),2.0))+1.0)) - 1.0;
