 ...
 */
public class CF5 extends AbstractDoubleProblem implements ConstrainedProblem<DoubleSolution> {
    ...
    public void evaluateConstraints(DoubleSolution solution) {
        ...
        constraint[0] = solution.getVariableValue(1) - 0.8*solution.getVariableValue(0)*Math.sin(6.0*solution.getVariableValue(0)*Math.PI+2.0*Math.PI/getNumberOfVariables()) - 0.5*solution.getVariableValue(0) + 0.25;
