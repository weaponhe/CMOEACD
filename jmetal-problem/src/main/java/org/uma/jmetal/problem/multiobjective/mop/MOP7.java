...
public class MOP7 extends AbstractDoubleProblem {
    ...
    public MOP7(Integer numberOfVariables, Integer numberOfObjectives) throws JMetalException {
    ...
    public void evaluate(DoubleSolution solution) {
        ...
        f[0] = (1.0 + g) * Math.cos(Math.PI * x1 / 2.0)
                * Math.cos(Math.PI * x2 / 2.0);
        f[1] = (1.0 + g) * Math.cos(Math.PI * x1 / 2.0)
                * Math.sin(Math.PI * x2 / 2.0);
        f[2] = (1.0 + g) * Math.sin(Math.PI * x1 / 2.0);
