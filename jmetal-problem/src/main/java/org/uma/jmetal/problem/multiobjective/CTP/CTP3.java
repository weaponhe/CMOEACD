 ...
 */
public class CTP3 extends CTP2 {
     ...
     * Constructor
     */
    public CTP3(CTP_VERSION version) {
        super(version);
        setName("CTP3");
    }
    /**
     * Constructor
     */
    public CTP3(String problemName,CTP_VERSION version) {
    ...
    public void evaluateConstraints(DoubleSolution solution) {
        ...
        double[] constraint  = constraint1(f,gFun(x),-0.2*Math.PI,0.1,10,1,0.5,1);
