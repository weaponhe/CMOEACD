 ...
 */
public class CMOEACDIV extends CMOEACD{
    public CMOEACDIV(Problem<DoubleSolution> problem,
                     int[] arrayH,
        ...
        violationThresholdComparator = new NormalizedViolationThresholdComparator<>(problem.getNumberOfConstraints());
    }

    public CMOEACDIV(Measurable measureManager, Problem<DoubleSolution> problem,
                     int[] arrayH,
                     double[] integratedTaus,
                     int populationSize,
                     int maxEvaluations,
