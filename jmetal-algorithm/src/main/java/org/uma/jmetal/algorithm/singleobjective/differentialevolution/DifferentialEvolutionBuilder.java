...
public class DifferentialEvolutionBuilder {
  public enum Variant{DE,DEMeasure};
  ...
  public DifferentialEvolutionBuilder(DoubleProblem problem) {
    ...
    this.DEVariant = Variant.DE;
  }

  public DifferentialEvolutionBuilder(DoubleProblem problem, Variant deVariant) {
    this.problem = problem;
    this.populationSize = 100;
    this.maxEvaluations = 25000;
    this.crossoverOperator = new DifferentialEvolutionCrossover(0.5, 0.5, "rand/1/bin");
  ...
  public DifferentialEvolution build() {
    if(DEVariant == Variant.DEMeasure){
      return new DifferentialEvolutionMeasure(problem, maxEvaluations, populationSize, crossoverOperator,
