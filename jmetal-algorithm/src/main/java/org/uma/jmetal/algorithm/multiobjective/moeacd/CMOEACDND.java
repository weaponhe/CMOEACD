 ...
 */
public class CMOEACDND extends CMOEACDD {
    public CMOEACDND(Problem<DoubleSolution> problem,
                     int[] arrayH,
    ...
    public CMOEACDND(Measurable measureManager,
...
//        }
    ...
    @Override public String getDescription() {
        return "MOEA/CD with constraints handling , normalization procedure and directions adaptation" ;
    }
}
