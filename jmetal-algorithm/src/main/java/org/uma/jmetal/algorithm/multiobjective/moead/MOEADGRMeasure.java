 ...
 */
public class MOEADGRMeasure extends MOEADGR implements Measurable {
    protected MyAlgorithmMeasures measure;
    MOEADGRMeasure(Problem<DoubleSolution> problem, int populationSize, int resultPopulationSize, int maxEvaluations,
