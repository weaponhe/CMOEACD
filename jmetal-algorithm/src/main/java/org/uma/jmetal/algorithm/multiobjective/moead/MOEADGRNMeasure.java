 ...
 */
public class MOEADGRNMeasure extends MOEADGRN implements Measurable {
    protected MyAlgorithmMeasures measure;
    MOEADGRNMeasure(Problem<DoubleSolution> problem, int populationSize, int resultPopulationSize, int maxEvaluations,
