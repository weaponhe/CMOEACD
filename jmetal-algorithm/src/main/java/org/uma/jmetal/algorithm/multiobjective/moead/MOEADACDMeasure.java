 ...
 */
public class MOEADACDMeasure extends MOEADACD implements Measurable {
    protected MyAlgorithmMeasures measure;
    MOEADACDMeasure(Problem<DoubleSolution> problem, int populationSize, int resultPopulationSize, int maxEvaluations,
