...
import org.uma.jmetal.util.comparator.impl.MaximumViolationThresholdComparatorII;
import org.uma.jmetal.util.comparator.impl.NormalizedViolationThresholdComparatorII;

/**
 * Created by X250 on 2017/1/7.
 */
public class CMOEACDVII extends CMOEACD{
    public CMOEACDVII(Problem<DoubleSolution> problem,
                    int[] arrayH,
        ...
        violationThresholdComparator = new MaximumViolationThresholdComparatorII<>();
    }

    public CMOEACDVII(Measurable measureManager, Problem<DoubleSolution> problem,
                    int[] arrayH,
                    double[] integratedTaus,
                    int populationSize,
                    int maxEvaluations,
