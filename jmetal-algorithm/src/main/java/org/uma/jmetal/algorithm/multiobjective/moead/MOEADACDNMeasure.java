 ...
 */
public class MOEADACDNMeasure extends MOEADACDN implements Measurable {
    protected MyAlgorithmMeasures measure;
    MOEADACDNMeasure(Problem<DoubleSolution> problem, int populationSize, int resultPopulationSize, int maxEvaluations,
