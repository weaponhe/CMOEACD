 ...
 */
public class MOEADDRAMeasure extends MOEADDRA implements Measurable{
    protected MyAlgorithmMeasures measure;
    MOEADDRAMeasure(Problem<DoubleSolution> problem, int populationSize, int resultPopulationSize, int maxEvaluations,
