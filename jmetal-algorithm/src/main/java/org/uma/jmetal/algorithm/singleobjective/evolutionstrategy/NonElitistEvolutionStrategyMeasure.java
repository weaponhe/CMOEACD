 ...
 */
public class NonElitistEvolutionStrategyMeasure extends NonElitistEvolutionStrategy<DoubleSolution> implements Measurable {
    protected MyAlgorithmMeasures<DoubleSolution> measure;
    protected int gen;
    /**
     * Constructor
     */
    public NonElitistEvolutionStrategyMeasure(Problem<DoubleSolution> problem, int mu, int lambda, int maxEvaluations,int popSize,
