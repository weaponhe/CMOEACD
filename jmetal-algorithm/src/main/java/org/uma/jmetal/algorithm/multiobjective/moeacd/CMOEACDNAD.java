 ...
 */
public class CMOEACDNAD extends CMOEACDAD {
    public CMOEACDNAD(Problem<DoubleSolution> problem,
                     int[] arrayH,
    ...
    public CMOEACDNAD(Measurable measureManager, Problem<DoubleSolution> problem,
                     int[] arrayH,
                     double[] integratedTaus,
                     int populationSize,
                     int maxEvaluations,
...
//        }
    ...
    @Override public String getName() {
        return "C-MOEA/CD-NAD" ;
    }

    @Override public String getDescription() {
        return "MOEA/CD with constraints handling , normalization procedure , archives and directions adaptation" ;
    }
