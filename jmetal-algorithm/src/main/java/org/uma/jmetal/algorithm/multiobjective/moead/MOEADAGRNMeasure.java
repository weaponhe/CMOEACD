 ...
 */
public class MOEADAGRNMeasure extends MOEADAGRN implements Measurable {
    protected MyAlgorithmMeasures measure;
    MOEADAGRNMeasure(Problem<DoubleSolution> problem, int populationSize, int resultPopulationSize, int maxEvaluations,
