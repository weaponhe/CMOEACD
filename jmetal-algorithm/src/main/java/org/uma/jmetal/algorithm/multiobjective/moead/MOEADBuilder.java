...
public class MOEADBuilder implements AlgorithmBuilder<AbstractMOEAD<DoubleSolution>> {
  public enum Variant {MOEAD,MOEADMeasure,MOEADDE,MOEADDEMeasure,ConstraintMOEAD, MOEADDRA,MOEADDRAMeasure, MOEADSTM,MOEADSTMMeasure, MOEADCD,MOEADCDMeasure, MOEADACD,MOEADACDMeasure,MOEADD,MOEADDMeasure,MOEADACDM,MOEADACDMMeasure
  ,MOEADN,MOEADNMeasure,MOEADACDN,MOEADACDNMeasure,MOEADDEN,MOEADDENMeasure,MOEADDN,MOEADDNMeasure,
  ...
  public int[] getNumOfDivision(){return numOfDivision;}
  public double[] getIntegratedTau(){return integratedTau;}
  ...
  /*modified by Yuehong Xie 2016/03/22*/
  public int getKIndex(){return kIndex;}
  /**/
