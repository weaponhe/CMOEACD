 ...
 */
public class MOEADCDMeasure  extends MOEADCD implements Measurable{
    protected MyAlgorithmMeasures measure;
    MOEADCDMeasure(Problem<DoubleSolution> problem, int populationSize, int resultPopulationSize, int maxEvaluations,
        ...
        super( problem, populationSize, resultPopulationSize, maxEvaluations, crossover, mutation, functionType, dataDirectory, neighborhoodSelectionProbability, maximumNumberOfReplacedSolutions, neighborSize, kIndex);
    ...
    MOEADCDMeasure(Problem<DoubleSolution> problem, int populationSize, int resultPopulationSize, int maxEvaluations,
                   ...
                   int maximumNumberOfReplacedSolutions, int neighborSize, int kIndex){
        super( problem, populationSize, resultPopulationSize, maxEvaluations, crossover, mutation, functionType, arrayH,integratedTau, neighborhoodSelectionProbability, maximumNumberOfReplacedSolutions, neighborSize, kIndex);
        measure = new MyAlgorithmMeasures<DoubleSolution>();
        measure.initMeasures();
    }
