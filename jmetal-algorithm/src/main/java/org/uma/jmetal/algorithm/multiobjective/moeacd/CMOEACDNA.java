 ...
 */
public class CMOEACDNA extends CMOEACDA {
    public CMOEACDNA(Problem<DoubleSolution> problem,
                    int[] arrayH,
    ...
    public CMOEACDNA(Measurable measureManager, Problem<DoubleSolution> problem,
                    int[] arrayH,
                    double[] integratedTaus,
                    int populationSize,
                    int maxEvaluations,
...
//        }
    ...
    @Override public String getDescription() {
        return "MOEA/CD with constraints handling , normalization procedure and archives" ;
    }
