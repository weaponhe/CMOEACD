 ...
 */
public class SRElitistEvolutionStrategyMeasure  extends SRElitistEvolutionStrategy<DoubleSolution> implements Measurable {
    protected MyAlgorithmMeasures<DoubleSolution> measure;
    protected int gen;
    /**
     * Constructor
     */
    public SRElitistEvolutionStrategyMeasure(Problem<DoubleSolution> problem, int mu, int lambda,double Pf, int maxEvaluations, int popSize,
                                           MutationOperator<DoubleSolution> mutation) {
        super(problem,mu,lambda,Pf,maxEvaluations,mutation) ;
