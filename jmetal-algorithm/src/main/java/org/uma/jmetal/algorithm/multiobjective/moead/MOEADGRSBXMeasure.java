 ...
 */
public class MOEADGRSBXMeasure extends MOEADGRSBX implements Measurable {
    protected MyAlgorithmMeasures measure;
    MOEADGRSBXMeasure(Problem<DoubleSolution> problem, int populationSize, int resultPopulationSize, int maxEvaluations,
