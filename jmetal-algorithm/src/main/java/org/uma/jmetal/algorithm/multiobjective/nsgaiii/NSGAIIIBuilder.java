...
public class NSGAIIIBuilder<S extends Solution<?>> implements AlgorithmBuilder<NSGAIII<S>>{
  public enum Variant {NSGAIII,NSGAIIIMeasure};
  ...
  private double[] intergratedTaus;

  protected Variant nsgaiiiVariant ;
  
  /** Builder constructor */
  public NSGAIIIBuilder(Problem<S> problem, Variant variant) {
    this.problem = problem ;
    maxIterations = 250 ;
    populationSize = 100 ;
    evaluator = new SequentialSolutionListEvaluator<S>() ;
    this.nsgaiiiVariant = variant;
  }
  ...
  public NSGAIIIBuilder<S> setIntergratedTaus(double[] intergratedTaus){
    this.intergratedTaus = intergratedTaus;
  ...
  public int[] getNumberOfDivisions(){return this.numberOfDivisions;}

  public double[] getIntergratedTaus(){return this.intergratedTaus;}
  ...
  public NSGAIII<S> build() {
    if(nsgaiiiVariant == Variant.NSGAIII)
      return new NSGAIII<>(this);
    else //(nsgaiiiVariant == Variant.NSGAIIIMeasure)
      return new NSGAIIIMeasure<>(this);
  }
}
