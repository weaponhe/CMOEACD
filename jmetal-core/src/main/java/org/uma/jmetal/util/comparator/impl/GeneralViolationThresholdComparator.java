 ...
 */
public class GeneralViolationThresholdComparator<S extends Solution<?>> extends ViolationThresholdComparator<S> {

    /**
     * Constructor
     */
    public GeneralViolationThresholdComparator() {
        super();
    }
    ...
    public int compare(S solution1, S solution2) {
        ...
        overall1 = overallConstraintViolation.getAttribute(solution1);
        overall2 = overallConstraintViolation.getAttribute(solution2);
    ...
    public boolean needToCompare(S solution1, S solution2) {
        ...
        double overall1, overall2;
        overall1 = Math.abs(overallConstraintViolation.getAttribute(solution1));
        overall2 = Math.abs(overallConstraintViolation.getAttribute(solution2));
    ...
    public boolean underViolationEp(S solution) {
        double overall;
        overall = Math.abs(overallConstraintViolation.getAttribute(solution));
    ...
    public double meanOverallViolation(List<S> solutionSet) {
        ...
        for (int i = 0; i < solutionSet.size(); i++) {
            aux += Math.abs(overallConstraintViolation.getAttribute(solutionSet.get(i)));
        }
