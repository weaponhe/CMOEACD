 ...
 */
public class MaximumViolationThresholdComparatorII<S extends Solution<?>> extends MaximumViolationThresholdComparator<S> {
    /**
     * Constructor
     */
    public MaximumViolationThresholdComparatorII() {
        super();
    }
    ...
    public int compare(S solution1, S solution2) {
        ...
        maximumViolation1 = maximumConstraintViolationDegree.getAttribute(solution1)*numberOfViolatedConstraints.getAttribute(solution1);
        maximumViolation2 = maximumConstraintViolationDegree.getAttribute(solution2)*numberOfViolatedConstraints.getAttribute(solution2);
    ...
    public boolean needToCompare(S solution1, S solution2) {
        ...
        double maximumViolation1, maximumViolation2;
        maximumViolation1 = Math.abs(maximumConstraintViolationDegree.getAttribute(solution1)*numberOfViolatedConstraints.getAttribute(solution1));
        maximumViolation2 = Math.abs(maximumConstraintViolationDegree.getAttribute(solution2)*numberOfViolatedConstraints.getAttribute(solution2));
    ...
    public boolean underViolationEp(S solution) {
        double maximumViolation = Math.abs(maximumConstraintViolationDegree.getAttribute(solution)*numberOfViolatedConstraints.getAttribute(solution));
    ...
    public double meanMaximumViolation(List<S> solutionSet) {
        ...
        for (int i = 0; i < solutionSet.size(); i++) {
            aux += Math.abs(maximumConstraintViolationDegree.getAttribute(solutionSet.get(i))*numberOfViolatedConstraints.getAttribute(solutionSet.get(i)));
        }
