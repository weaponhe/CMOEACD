...
public class DifferentialEvolutionCrossover implements CrossoverOperator<DoubleSolution> {
   ...
   * @param variant
   */
  public DifferentialEvolutionCrossover(double cr, double f, String variant, RepairDoubleSolution solutionRepair) {
    this.cr = cr;
    this.f = f;
    this.k = DEFAULT_K ;
  ...
  public DifferentialEvolutionCrossover(double cr, double f, String variant) {
    this (cr,  f,  variant, new RepairDoubleSolutionAtBounds()) ;
  }

  /** Constructor */
  public DifferentialEvolutionCrossover(double cr, double f, double k, String variant, RepairDoubleSolution solutionRepair) {
    this(cr, f, variant,solutionRepair) ;
    this.k = k ;
  }

  /** Constructor */
  public DifferentialEvolutionCrossover(double cr, double f, double k, String variant) {
    this (cr,  f,  k,variant, new RepairDoubleSolutionAtBounds()) ;
  }
