...
public interface SolutionEvaluator<Solution> {
	 ...
	 * @param <Value>
	 */
	public static interface Constraint<Solution, Value> extends DescribedEntity {
		/**
		 *
		 * @param solution
		 *            the {@link Solution} to read
		 * @return the {@link Value} of the {@link Constraint} for this
		 *         {@link Solution}
		 */
		public Value get(Solution solution);
	}
	...
	/**
	 *
	 * @return the list of {@link Constraint}s managed by this
	 *         {@link SolutionEvaluator}
	 */
