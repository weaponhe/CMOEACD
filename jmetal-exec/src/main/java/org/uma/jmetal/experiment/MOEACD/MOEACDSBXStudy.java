 ...
 */
public class MOEACDSBXStudy extends AbstractMOEACDStudy{
    public MOEACDSBXStudy() {
        super("MOEACD-SBX");
        this.algType = MOEACDBuilder.Variant.MOEACDSBX;
        this.measureAlgType = MOEACDBuilder.Variant.MOEACDSBXMeasure;
    }
