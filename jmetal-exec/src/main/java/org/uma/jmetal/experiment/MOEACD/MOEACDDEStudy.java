 ...
 */
public class MOEACDDEStudy extends AbstractMOEACDStudy{
    public MOEACDDEStudy() {
        super("MOEACD-DE");
        this.algType = MOEACDBuilder.Variant.MOEACDDE;
        this.measureAlgType = MOEACDBuilder.Variant.MOEACDDEMeasure;
    }
