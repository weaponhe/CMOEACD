 ...
 */
public class DTLZ3PFGenerator  extends DTLZPFGenerator{
    public DTLZ3PFGenerator(int _popSize,int _nObj,int _H){
        super(_popSize,_nObj,_H);
        setInstanceName("DTLZ3");
    }

    public DTLZ3PFGenerator(int _popSize,int _nObj,int[] _arrayH,double[] _arrayTao){
