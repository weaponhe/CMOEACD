...
import org.uma.jmetal.solution.util.RepairDoubleSolutionByFold;
...
/**
 * Created by X250 on 2016/5/1.
 */
public abstract class AbstractMOEACDStudy {
    protected String algName="";
    protected MOEACDBuilder.Variant algType;
    protected MOEACDBuilder.Variant measureAlgType;
    public AbstractMOEACDStudy(String algName){
    ...
    public AbstractMOEACD createAlgInstance(MOEACDBuilder.Variant algType,
        ...
        AbstractMOEACD algorithm = new MOEACDBuilder(problem, algType)
                ...
                .setNumOfDivision(divisionConfig)
                .setIntegratedTaus(tauConfig)
        ...
        for(int iProblem=0;iProblem<problemList.size();++iProblem) {
            ...
            for (int iRun = 0; iRun < maxRun; ++iRun) {
                ...
                AbstractMOEACD algorithm = createAlgInstance(measureAlgType,
                                                    ...
                                                    divisionConfigList[iProblem],
                                                    tauConfigList[iProblem]);
