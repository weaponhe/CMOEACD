 ...
 */
public class DTLZ1PFGenerator extends DTLZPFGenerator{
    public DTLZ1PFGenerator(int _popSize,int _nObj,int _H){
        super(_popSize,_nObj,_H);
        setInstanceName("DTLZ1");
    }
    public DTLZ1PFGenerator(int _popSize,int _nObj,int[] _arrayH,double[] _arrayTao){
