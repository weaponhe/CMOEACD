 ...
 */
public class DTLZ4PFGenerator  extends DTLZPFGenerator{
    public DTLZ4PFGenerator(int _popSize,int _nObj,int _H){
        super(_popSize,_nObj,_H);
        setInstanceName("DTLZ4");
    }
    public DTLZ4PFGenerator(int _popSize,int _nObj,int[] _arrayH,double[] _arrayTao){
